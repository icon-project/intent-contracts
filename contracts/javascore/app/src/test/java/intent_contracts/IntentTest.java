...
public class IntentTest extends TestBase {
    ...
    void setup() throws Exception {
        ...
        tokenAccount = token.tokenContract.getAccount();
    ...
    void testSwap() {
        ...
        TokenFallbackData fallbackData = new TokenFallbackData(swapOrder.toBytes(), "swap", "");
        ...
        intent.invoke(tokenAccount, "tokenFallback", user1.getAddress(), amount, fallbackData.toBytes());
    ...
    void testSwapInvalidCreator() {
        ...
        UserRevertedException exception = assertThrows(UserRevertedException.class,
                () -> {
                    intent.invoke(tokenAccount, "tokenFallback", user1.getAddress(), amount,
    ...
    void testFillOrder() {
        ...
        TokenFallbackData fallbackData = new TokenFallbackData(swapOrder.toBytes(), "fill",
    ...
    void testResolveOrder() {
        ...
        assertEquals(intent.call("getReceipts", dstNID, conn), true);
    }
    ...
    void testResolveCancel() {
        ...
        destinationAddress = user2.getAddress().toString();
        toToken = swapToken;
        SwapOrderDb swapOrder = new SwapOrderDb(id, emitter, dstNID,
                srcNID, creator, destinationAddress,
                swapToken, amount, toToken, toAmount, data);
        ...
        OrderMessage orderMessage = new OrderMessage(OrderAction.CANCEL.getValue(),
                new Cancel(swapOrder.toBytes()).toBytes());
